...
namespace lyrics
{
	...
	void ErrorHandler::OnWarning(const Location location, const WarningCode warningCode)
	{
		switch (warningCode)
		{
	...
	void ErrorHandler::OnError(const Location location, const ErrorCode errorCode)
	{
		switch (errorCode)
		{
	...
	void ErrorHandler::OnFatalError(const FatalErrorCode &fatalErrorCode)
	{
